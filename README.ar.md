...
- إضافة رابط واحد أو عدة روابط أو قوائم تشغيل إلى قائمة الانتظار.
- مكتبة محلية مع صور مصغرة، روابط المصدر، إجراءات الملفات، وفتح المشاهدة أو القص.
- قص المقاطع، نسخ الملفات، فتح المجلدات، وتصدير النتيجة النهائية.
- تحميل ملفات الترجمة وتعديلها وترجمتها وتنسيقها وإخفاؤها واستعادتها ودمجها مع الفيديو.
